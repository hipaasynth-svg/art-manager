# Studio Playbook — what's working (auto-updated; prune freely)

The agent appends dated learnings here after each run and reads them back on the
next one, so it doubles down on what works and drops what doesn't. You can edit
or delete anything here — treat it as the studio's growing gut instinct.
